...
import (
	"fmt"
	"github.com/connect2naga/go-examples/kafka/pkg/config"
	"github.com/connect2naga/go-examples/kafka/pkg/consumer"
	"github.com/connect2naga/go-examples/kafka/pkg/producer"
	"log"
	"os"
	"os/signal"
	"time"
